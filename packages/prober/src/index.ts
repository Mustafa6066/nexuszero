...
export { SerperProber } from './providers/serper-prober.js';
...
// Standalone web search (no caching, direct results)
export { webSearch } from './web-search.js';
export type { WebSearchResult } from './web-search.js';

// YouTube monitoring client
export { searchYouTube, getVideoComments } from './youtube-client.js';
export type { YouTubeSearchResult, YouTubeComment } from './youtube-client.js';
